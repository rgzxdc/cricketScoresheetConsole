...
void inputPlayer() {
    if(currentInnings == 1) {
        ...
        for(int i=0; i<11; i++){
            ...
            fflush(stdin);
            batsManTeamA[i].runs = 0;
            batsManTeamA[i].balls = 0;
            batsManTeamA[i].fours = 0;
            batsManTeamA[i].sixes = 0;
            //live print
            gotoxy(39,9+(i+1));
        ...
        for(int i=0; i<8; i++){
            ...
            bowlerTeamA[i].overs = 0;
            bowlerTeamA[i].maiden = 0;
            bowlerTeamA[i].runs = 0;
            bowlerTeamA[i].wicket = 0;
            bowlerTeamA[i].extra = 0;
            bowlerTeamA[i].Economy = 0;
            //
            gotoxy(37,25+(i+1));
        ...
        for(int i=0; i<11; i++){
            ...
            fflush(stdin);
            batsManTeamB[i].runs = 0;
            batsManTeamB[i].balls = 0;
            batsManTeamB[i].fours = 0;
            batsManTeamB[i].sixes = 0;
            //for live print
            gotoxy(39,9+(i+1));
        ...
        for(int i=0; i<8; i++){
            ...
            bowlerTeamB[i].overs = 0;
            bowlerTeamB[i].maiden = 0;
            bowlerTeamB[i].runs = 0;
            bowlerTeamB[i].wicket = 0;
            bowlerTeamB[i].extra = 0;
            bowlerTeamB[i].Economy = 0;
            //
            gotoxy(37,25+(i+1));
